...
import ReactJQueryUI from './ReactJQueryUI';
var Dialog = ReactJQueryUI["Dialog"];
...
class FetchData extends React.Component<WeatherForecastProps, void> {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (this.props.isLoading) {
            this.loadingDialog.$.dialog().dialog("open")
        } else
        {
            this.loadingDialog.$.dialog().dialog("close")
        }
    }
    ...
    private renderPagination() {
        ...
        return <p className='clearfix text-center'>
            ...
            <Dialog modal="true" autoOpen={false} ref={(dialog) => { this.loadingDialog = dialog; } } >
